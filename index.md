...
Unicode character set numbers over 128 000 symbols by now, which covers most all known alphabets, math and note signs, newly invented emoji, etc., yet the domain keeps on growing. Unicode is exactly what allows a programmer to be sure 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxNDkwNTk5NSwyMDE5MDE2MjYxLC03Nz
