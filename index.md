...
The idea underlying the Unicode concept is to 

map each and every character in the Unicode character set  as idealistic platonic entities, each and every known one, to "magic numbers", or *code points*, which then will be somehow *encoded* to obtain an in-memory representation of the character.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM3MTg5NjcwLDI4MzQxODk1NCw5ODg5MD
